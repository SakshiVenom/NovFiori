sap.ui.define([
    ...
    return BaseController.extend("tcs.fin.payroll.controller.View2",{
        onInit: function(){
            ...
            this.oRouter.getRoute("detail").attachMatched(this.hercules, this);
        },
        onTest: function(){
        ...
        onItemPress:function(oEvent){
            // MessageBox.confirm("I confirm to Anubhav that I will implement the 3rd View and navigate to the supplier details on the"+
            // " weekend");
        ...
        //adding element with duplicate id 'city--popup'
        cityPopup: null,
        oField: null,
